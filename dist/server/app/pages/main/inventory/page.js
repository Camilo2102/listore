...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3902)), "D:\\listore\\listore\\src\\app\\pages\\main\\inventory\\page.tsx"],
    ...
    const pages = ["D:\\listore\\listore\\src\\app\\pages\\main\\inventory\\page.tsx"];
    ...
    const originalPathname = "/pages/main/inventory/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 98875))
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Z: () => (/* binding */ useConfirmationService)
/* harmony export */ });
/* harmony import */ var _app_constants_messageConstant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(33538);
/* harmony import */ var primereact_confirmdialog__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(82558);
...
function useConfirmationService() {
     ...
     */ const showConfirmDelete = (body, acceptFn)=>{
        (0,primereact_confirmdialog__WEBPACK_IMPORTED_MODULE_1__/* .confirmDialog */ .VG)({
            message: body,
            header: _app_constants_messageConstant__WEBPACK_IMPORTED_MODULE_0__/* .Messages */ .V.MESSAGE_HEAER_DELETE,
...
;// CONCATENATED MODULE: ./src/app/components/inventoryComponents/registerInventory.tsx
...
function RegisterInventory({ inventorySelected, visible, setVisible }) {
    const { create } = (0,useCRUDService/* default */.Z)(endpointsConstants/* Endpoints */.A.INVENTORY);
    ...
    const [inventoryToRegister, form, setInventoryToRegister, validateFormControls] = (0,useHandleForm/* useHandleForm */.p)(controls);
    ...
    const handleInventory = (e)=>{
        ...
        if (valid) {
            ...
            create(true, {
                ...
                showSuccess(messageConstant/* Messages */.V.MESSAGE_SUCCESS, mainInventory ? messageConstant/* Messages */.V.MESSAGE_UPDATE_SUCCESS : messageConstant/* Messages */.V.MESSAGE_CREATE_SUCCESS);
                setVisible(false);
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
        children: /*#__PURE__*/ jsx_runtime_.jsx(popUp/* default */.Z, {
            ...
            children: /*#__PURE__*/ jsx_runtime_.jsx(formGenerator/* default */.Z, {
                form: form,
                value: inventoryToRegister,
                setValue: setInventoryToRegister,
                submit: handleInventory,
                buttonLabel: "Crear"
            })
        })
    });
...
// EXTERNAL MODULE: ./src/app/hooks/services/useConfirmationService.ts
var useConfirmationService = __webpack_require__(86821);
// EXTERNAL MODULE: ./src/app/hooks/useDidMountEffect.ts
var useDidMountEffect = __webpack_require__(67103);
;// CONCATENATED MODULE: ./src/app/pages/main/inventory/page.tsx
/* __next_internal_client_entry_do_not_use__ default auto */ 
...
function Inventory() {
    ...
    const { deleteData } = (0,useCRUDService/* default */.Z)(endpointsConstants/* Endpoints */.A.INVENTORY);
    const { reloadData, setReloadData } = (0,tableContext/* useTableContext */.S)();
    const { mainInventory, setMainInventory } = (0,mainContext/* useMainContext */.H)();
    const { setSupplier } = (0,supplierContext/* useSupplier */.jB)();
    const { showConfirmDelete } = (0,useConfirmationService/* default */.Z)();
    const { isValidRes } = (0,resErrorHandler/* default */.Z)();
    const { showSuccess } = (0,toastContext/* useToastContext */.V)();
    const columns = [
        {
        ...
        },
        {
            ...
            header: "Eliminar",
            action: (t)=>{
                showConfirmDelete(messageConstant/* Messages */.V.MESSAGE_BODY_DELETE + t.name, handleDelete(t));
            }
        }
    ];
    ...
    const handleDelete = (t)=>{
        const deleteFn = ()=>{
            deleteData(true, t.id).then((res)=>{
                ...
                showSuccess(messageConstant/* Messages */.V.MESSAGE_SUCCESS, messageConstant/* Messages */.V.MESSAGE_DELETE_SUCCESS);
                setMainInventory(undefined);
                setReloadData(true);
            });
        };
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            ...
            children: [
                ...
                visible && /*#__PURE__*/ jsx_runtime_.jsx(RegisterInventory, {
                    visible: visible,
                    setVisible: setVisible
                })
            ]
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\listore\listore\src\app\pages\main\inventory\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,681,905,531,137,977,924], () => (__webpack_exec__(75218)));
