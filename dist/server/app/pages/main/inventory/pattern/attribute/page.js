...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 62378)), "D:\\listore\\listore\\src\\app\\pages\\main\\inventory\\pattern\\attribute\\page.tsx"],
          
        }]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 78038)), "D:\\listore\\listore\\src\\app\\pages\\main\\inventory\\pattern\\attribute\\layout.tsx"],
          
        }
      ]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 27062)), "D:\\listore\\listore\\src\\app\\pages\\main\\inventory\\pattern\\layout.tsx"],
          
        }
      ]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 68847)), "D:\\listore\\listore\\src\\app\\pages\\main\\inventory\\layout.tsx"],
          
        }
      ]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 44330)), "D:\\listore\\listore\\src\\app\\pages\\main\\layout.tsx"],
          
        }
      ]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 94076)), "D:\\listore\\listore\\src\\app\\pages\\layout.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 54232)), "D:\\listore\\listore\\src\\app\\layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 82819))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["D:\\listore\\listore\\src\\app\\pages\\main\\inventory\\pattern\\attribute\\page.tsx"];
    ...
    const originalPathname = "/pages/main/inventory/pattern/attribute/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 74866))
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 58936))
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $: () => (/* binding */ attributeContext)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(18038);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* __next_internal_client_entry_do_not_use__ attributeContext auto */ 
const attributeContext = /*#__PURE__*/ (0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)({});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ AttributeLayout)
/* harmony export */ });
...
/* harmony import */ var _attributeContext__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(47919);
/* __next_internal_client_entry_do_not_use__ default auto */ 


function AttributeLayout({ children }) {
    const [attribute, setAttribute] = (0,_app_hooks_useHandleContextHook__WEBPACK_IMPORTED_MODULE_1__/* .useHandleContext */ .W)("attribute");
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_attributeContext__WEBPACK_IMPORTED_MODULE_2__/* .attributeContext */ .$.Provider, {
        value: {
            attribute,
            setAttribute
        },
...
// EXTERNAL MODULE: ./src/app/components/titleTables.tsx
var titleTables = __webpack_require__(43661);
...
// EXTERNAL MODULE: ./src/app/pages/main/inventory/pattern/attribute/attributeContext.tsx
var attributeContext = __webpack_require__(47919);
// EXTERNAL MODULE: ./src/app/pages/main/inventory/pattern/patternContext.tsx
var patternContext = __webpack_require__(15401);
// EXTERNAL MODULE: ./src/app/constants/formTypeConstant.ts
var formTypeConstant = __webpack_require__(42550);
// EXTERNAL MODULE: ./src/app/constants/messageConstant.ts
var messageConstant = __webpack_require__(33538);
...
// EXTERNAL MODULE: ./src/app/models/general.ts
var general = __webpack_require__(42836);
;// CONCATENATED MODULE: ./src/app/models/pattern.ts

class PatternModel extends general/* default */.Z {
}
...
;// CONCATENATED MODULE: ./src/app/components/atributesComponentes/RegisterAtribute.tsx
...
function RegisterAttribute({ visible, setVisible }) {
    const { create } = (0,useCRUDService/* default */.Z)(endpointsConstants/* Endpoints */.A.ATTRIBUTES);
    const { isValidRes } = (0,resErrorHandler/* default */.Z)();
    const { showSuccess } = (0,toastContext/* useToastContext */.V)();
    const { requiered, maxLenght, minLenght } = (0,validators/* default */.Z)();
    const [controls, setControls] = (0,react_.useState)([
        {
            field: "name",
            value: "",
            description: "Nombre",
    ...
    const [attributeToRegister, form, setAttributeToRegister, validateFormControls] = (0,useHandleForm/* useHandleForm */.p)(controls);
    const { pattern, setPattern } = (0,react_.useContext)(patternContext/* patternContext */.m);
    const { attribute, setAttribute } = (0,react_.useContext)(attributeContext/* attributeContext */.$);
    const [submited, setSubmited] = (0,react_.useState)(false);
    const handleAttribute = (e)=>{
        ...
        if (valid) {
            ...
            create(true, attributeToRegister).then((res)=>{
                if (!isValidRes(res)) {
                    return;
                }
                showSuccess(messageConstant/* Messages */.V.MESSAGE_SUCCESS, attribute ? messageConstant/* Messages */.V.MESSAGE_CREATE_SUCCESS : messageConstant/* Messages */.V.MESSAGE_UPDATE_SUCCESS);
                setVisible(false);
                setSubmited(false);
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
        children: /*#__PURE__*/ jsx_runtime_.jsx(popUp/* default */.Z, {
            ...
            children: /*#__PURE__*/ jsx_runtime_.jsx(formGenerator/* default */.Z, {
                form: form,
                setValue: setAttributeToRegister,
                submit: handleAttribute,
                value: attributeToRegister,
                buttonLabel: "Crear"
            })
        })
    });
...
;// CONCATENATED MODULE: ./src/app/pages/main/inventory/pattern/attribute/page.tsx
/* __next_internal_client_entry_do_not_use__ default auto */ 
...
function AttributePage() {
    ...
    const { pattern, setPattern } = (0,react_.useContext)(patternContext/* patternContext */.m);
    const { reloadData, setReloadData } = (0,tableContext/* useTableContext */.S)();
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ jsx_runtime_.jsx(titleTables/* default */.Z, {
                                title: "Atributos"
                            }),
                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                className: "col-12 flex justify-content-start",
                            ...
                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                ...
                                children: /*#__PURE__*/ jsx_runtime_.jsx(tableGeneral/* default */.Z, {
                                    columns: columns,
                                    baseFilter: attributeFilter,
                                    endpoint: endpointsConstants/* Endpoints */.A.ATTRIBUTES,
                                    showRepotGenerator: false
                                })
                            })
                        ]
                    }),
                    visible && /*#__PURE__*/ jsx_runtime_.jsx(RegisterAttribute, {
                        visible: visible,
                        setVisible: setVisible
                    })
                ]
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\listore\listore\src\app\pages\main\inventory\pattern\attribute\layout.tsx`)
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\listore\listore\src\app\pages\main\inventory\pattern\attribute\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,681,905,531,137,977,924,358], () => (__webpack_exec__(13200)));
