...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 91766)), "D:\\listore\\listore\\src\\app\\pages\\main\\spent\\page.tsx"],
          
        }]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 59700)), "D:\\listore\\listore\\src\\app\\pages\\main\\spent\\layout.tsx"],
    ...
    const pages = ["D:\\listore\\listore\\src\\app\\pages\\main\\spent\\page.tsx"];
    ...
    const originalPathname = "/pages/main/spent/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 42689))
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 13471))
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SpentLayout)
/* harmony export */ });
...
/* harmony import */ var _spentContext__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(93425);
/* __next_internal_client_entry_do_not_use__ default auto */ 


function SpentLayout({ children }) {
    const [spent, setSpent] = (0,_app_hooks_useHandleContextHook__WEBPACK_IMPORTED_MODULE_1__/* .useHandleContext */ .W)("spent");
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_spentContext__WEBPACK_IMPORTED_MODULE_2__/* .spentContext */ .R.Provider, {
        value: {
            spent,
            setSpent
        },
...
// EXTERNAL MODULE: ./src/app/pages/main/spent/spentContext.tsx
var spentContext = __webpack_require__(93425);
...
;// CONCATENATED MODULE: ./src/app/components/spentComponets/registerSpent.tsx
...
function RegisterSpent({ visible, setVisible }) {
    const { createAll } = (0,useCRUDService/* default */.Z)(endpointsConstants/* Endpoints */.A.SPENT);
    const [spents, setspents] = (0,react_.useState)([]);
    const [newSpentVisible, setNewSpentVisible] = (0,react_.useState)(false);
    ...
    const [spentToRegister, form, setSpentToRegister, validateFormControls] = (0,useHandleForm/* useHandleForm */.p)(controls);
    const { spent, setSpent } = (0,react_.useContext)(spentContext/* spentContext */.R);
    ...
    const loadSpents = ()=>{
        ...
        createAll(true, modifiedSpents).then((res)=>{
            ...
            showSuccess(messageConstant/* Messages */.V.MESSAGE_SUCCESS, messageConstant/* Messages */.V.MESSAGE_CREATE_SUCCESS);
            setVisible(false);
            setSubmited(false);
            setSpent(undefined);
        });
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)(popUp/* default */.Z, {
                ...
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        ...
                        children: /*#__PURE__*/ jsx_runtime_.jsx(button_cjs.Button, {
                            label: "Agregar",
                            icon: "pi pi-plus",
                            onClick: ()=>setNewSpentVisible(true)
                        })
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx(tableGeneral/* default */.Z, {
                        useFilter: false,
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(popUp/* default */.Z, {
                title: "Nuevo Gasto",
                visible: newSpentVisible,
                setVisible: setNewSpentVisible,
                children: /*#__PURE__*/ jsx_runtime_.jsx(formGenerator/* default */.Z, {
                    form: form,
                    setValue: setSpentToRegister,
                    submit: addSpent,
                    value: spentToRegister,
                    buttonLabel: "Agregar"
                })
            })
        ]
...
// EXTERNAL MODULE: ./src/app/constants/formatConstants.tsx
var formatConstants = __webpack_require__(74470);
// EXTERNAL MODULE: ./src/app/hooks/useDidMountEffect.ts
var useDidMountEffect = __webpack_require__(67103);
;// CONCATENATED MODULE: ./src/app/pages/main/spent/page.tsx
/* __next_internal_client_entry_do_not_use__ default auto */ 
...
function SpentPage() {
    ...
    const { getCredentials } = (0,authUtils/* default */.Z)();
    const { formatDate } = (0,formatConstants/* useFormats */.y)();
    const { setReloadData } = (0,tableContext/* useTableContext */.S)();
    const spentFilter = {
        required: {
            user: {
                id: getCredentials().user
    ...
    const { setSpent } = (0,react_.useContext)(spentContext/* spentContext */.R);
    const columns = [
        {
            field: "spentDate",
    ...
    const customMap = (spents)=>{
        return {
            ...spents,
            spentDate: formatDate(spents.spentDate)
        };
    };
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                ...
                                children: /*#__PURE__*/ jsx_runtime_.jsx(tableGeneral/* default */.Z, {
                                    columns: columns,
                                    baseFilter: spentFilter,
                                    endpoint: endpointsConstants/* Endpoints */.A.SPENT,
                                    customMap: customMap
                                })
                            })
                        ]
                    }),
                    visible && /*#__PURE__*/ jsx_runtime_.jsx(RegisterSpent, {
                        visible: visible,
                        setVisible: setVisible
                    })
                ]
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   R: () => (/* binding */ spentContext)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(18038);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* __next_internal_client_entry_do_not_use__ spentContext auto */ 
const spentContext = /*#__PURE__*/ (0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)({});
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\listore\listore\src\app\pages\main\spent\layout.tsx`)
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\listore\listore\src\app\pages\main\spent\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,681,905,531,137,977,549], () => (__webpack_exec__(45375)));
