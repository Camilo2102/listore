...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 80437)), "D:\\listore\\listore\\src\\app\\pages\\main\\user\\mainteance\\page.tsx"],
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 36500)), "D:\\listore\\listore\\src\\app\\pages\\main\\user\\layout.tsx"],
    ...
    const pages = ["D:\\listore\\listore\\src\\app\\pages\\main\\user\\mainteance\\page.tsx"];
    ...
    const originalPathname = "/pages/main/user/mainteance/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 38440))
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ UserMainteance)
});
...
// EXTERNAL MODULE: ./src/app/pages/main/user/userContext.tsx
var userContext = __webpack_require__(10624);
// EXTERNAL MODULE: ./src/app/components/container.tsx
var container = __webpack_require__(20079);
...
// EXTERNAL MODULE: ./src/app/constants/roleValues.ts + 1 modules
var roleValues = __webpack_require__(85103);
...
;// CONCATENATED MODULE: ./src/app/components/userComponents/RegisterWorker.tsx
...
function RegisterWorker({ userSelected }) {
    const { registerUser } = (0,useAuthService/* default */.Z)();
    const { update } = (0,useCRUDService/* default */.Z)(endpointsConstants/* Endpoints */.A.USER);
    ...
    const { showSuccess, showError } = (0,toastContext/* useToastContext */.V)();
    const { requiered, maxLenght, minLenght } = (0,validators/* default */.Z)();
    const [submited, setSubmited] = (0,react_.useState)(false);
    const [workerToRegister, setWorkerToRegister] = (0,react_.useState)({
        name: "",
        role: "",
        active: "N",
        credential: {
     ...
     */ const [controls, setControls] = (0,react_.useState)([
        ...
        },
        {
            field: "role",
            value: "",
            type: formTypeConstant/* FormTypes */.h.DROPDOWN,
            colSize: 12,
            description: "Rol",
            validators: [
                requiered
            ...
            invalid: false,
            message: true,
            options: roleValues/* RolesOptions */.W
        }
    ]);
    /**
     ...
     */ const [user, form, setUser, validateFormControls] = (0,useHandleForm/* useHandleForm */.p)(controls);
    const handleRegisterWorker = (e)=>{
        ...
        if (valid) {
            ...
            showError(messageConstant/* Messages */.V.MESSAGE_ERROR, messageConstant/* Messages */.V.MESSAGE_PASSWORD_MISMATCH);
        }
    };
    const registerNewWorker = ()=>{
        registerUser(workerToRegister).then((res)=>{
            if (!isValidRes(res)) {
                return;
            }
    ...
    const updateWorker = ()=>{
        update(true, workerToRegister).then((res)=>{
            if (!isValidRes(res)) {
                return;
            }
            showSuccess(messageConstant/* Messages */.V.MESSAGE_SUCCESS, messageConstant/* Messages */.V.MESSAGE_UPDATE_SUCCESS);
            goToRoute("/pages/main/user");
        });
    };
    (0,react_.useEffect)(()=>{
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: /*#__PURE__*/ jsx_runtime_.jsx(container/* default */.Z, {
            ...
            children: /*#__PURE__*/ jsx_runtime_.jsx(formGenerator/* default */.Z, {
                buttonLabel: userSelected === undefined ? "Guardar" : "Actualizar",
                update: userSelected === undefined,
                form: form,
                value: user,
                setValue: setUser,
                submit: handleRegisterWorker
            })
        })
    });
}
...
;// CONCATENATED MODULE: ./src/app/pages/main/user/mainteance/page.tsx
/* __next_internal_client_entry_do_not_use__ default auto */ 




function UserMainteance() {
    const { user, setUser } = (0,react_.useContext)(userContext/* userContext */.x);
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: "lg:col-6 md:col-6 col-12 lg:p-8",
                children: /*#__PURE__*/ jsx_runtime_.jsx(RegisterWorker, {
                    userSelected: user
                })
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: "lg:col-6 md:col-6 hidden md:flex justify-content-center align-items-center",
                children: /*#__PURE__*/ jsx_runtime_.jsx((image_default()), {
                    src: "/registerEmployee.svg",
                    alt: "Login",
                    style: {
                        maxWidth: "750px",
                        width: "80%"
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\listore\listore\src\app\pages\main\user\mainteance\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,681,905,421,531,137,977,79,897], () => (__webpack_exec__(84351)));
