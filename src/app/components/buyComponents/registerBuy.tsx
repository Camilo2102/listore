...
import { userContext } from "@/app/pages/main/user/userContext";
import User from "@/app/models/user";
import { AuthUtil } from "@/app/utils/authUtil";

export default function BuyAtribute({visible, setVisible}: {visible: boolean, setVisible: (partialT: Partial<boolean>) => void}){
